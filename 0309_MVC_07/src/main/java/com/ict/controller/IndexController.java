...
public class IndexController {
	...
	public ModelAndView getF_up01(HttpServletRequest request, HttpServletResponse reponse) {
				
		return new ModelAndView("error");
	}
	
	@RequestMapping(value = "f_up.do", method=RequestMethod.POST)
	public ModelAndView getF_up02(HttpServletRequest request, HttpServletResponse reponse) {
		ModelAndView mv = new ModelAndView();
	...
	public ModelAndView getF_up03(HttpServletRequest request, HttpServletResponse reponse) {
	...
	public ModelAndView getF_up04(@RequestParam( "f_name") MultipartFile file,
