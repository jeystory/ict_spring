...
<body>
	...
	<div class = "main_content">
				...
				<form method="post" enctype="multipart/form-data">
					<table>
						<thead><tr><th colspan = "3">관리자 제품 추가</th></tr></thead>
						<tbody></tbody>
						...
						<tr>
							<td>제품소개:</td>
							<td colspan="2"><textarea name="item_spec"></textarea></td>
						</tr>
						<tr>
							<td>제품가격:</td>
						...
						<tr>
							<td>총내용량:</td>
							<td colspan="2"><textarea name="item_cal"></textarea></td>
						</tr>
						<tr>
							<td>구성성분:</td>
							<td colspan="2"><textarea  name="item_content"></textarea></td>
						</tr>
						<tr>
							<td>알레르기:</td>
